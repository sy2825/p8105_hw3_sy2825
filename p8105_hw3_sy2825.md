...
```
    ...
    ## # A tibble: 1,458,900 x 10
    ##    id    date       precipitation_mm snowfall_mm snow_depth_mm tmax_c
    ##    <chr> <date>                <dbl>       <int>         <int>  <dbl>
    ##  1 USC0~ 1981-01-03              0             0             0  -12.2
    ##  2 USC0~ 1981-01-05              0             0             0   -5.6
    ##  3 USC0~ 1981-01-12              0             0             0  -12.2
    ##  4 USC0~ 1981-01-13              0             0             0   -6.7
    ##  5 USC0~ 1981-01-15              0             0             0   -5  
    ##  6 USC0~ 1981-01-17              0             0             0   -1.1
    ##  7 USC0~ 1981-01-20              0             0             0    6.1
    ##  8 USC0~ 1981-01-21              0             0             0    1.7
    ##  9 USC0~ 1981-01-22              0             0             0    0.6
    ## 10 USC0~ 1981-01-23             11.7         127            76    2.2
    ## # ... with 1,458,890 more rows, and 4 more variables: tmin_c <dbl>,
    ## #   year <dbl>, month <chr>, day <int>
